<template>
  <div class="news-card">
    ...
    <div class="item-imgbox">
      <div class="news-img" :style="{ backgroundImage: 'url(' + backgroundImage + ')' }"></div>
...
export default {
  props: {
    title: {
      type: String,
      default: 'amis 是一个低代码前端框架，它使用 JSON 配置来生成页面，可以减少页面开发工作量，极大提升效率。'
    },
    backgroundImage: {
      type: String,
      default: 'https://search-operate.cdn.bcebos.com/64c279f23794a831f9a8e7a4e0b722dd.jpg'
    },
    img_count: {
      type: Number,
      default: 3
